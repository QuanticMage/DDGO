...
{	
	...
	public static class EventPriceGuide
	{
		...
		public static readonly EventItemInfo[] EventInfo = 
		{
			...
			new ("Blu", "Pets > Collectibles", "Fortified Heroic Relic Deletes Locked Necromancer", 51),
			new ("Blueberry", "Pets > Guardians", "Radiant Nerfed Shiro Withstands Wild Brood", 182),
			...
			new ("Boneyard Blade", "Weapons > Squire", "Tilted Mythic Workshop Shatters Brutal Wretch", 47),
			...
			new ("Carapace of the Queen", "Accessories > Shields", "Swift Swift Shiro Wipes Swift Necromancer", 59),
			...
			new ("Delver's Bracers", "Accessories > High End Bracers", "Fortified Mythic Fireball Builds Hardened Demon", 593),
			...
			new ("Delver's Eyewear", "Accessories > High End Masks", "Swift Fortified Core Locks Fortified Shaman", 724), // updated
			...
			new ("Final Patch", "Accessories > High End Masks", "Fortified Wild Relic Wins Wild Wretch", 484),
			...
			new ("Rosemary", "Pets > Streamer", "Drippy Wild Shiro Boosts Endless Brute", 243),
			...
			new ("Staff of the Pumpkin King", "Weapons > Apprentice", "Endless Hardened Banner Shatters Enchanted Warlock", 50),
			...
			new ("Strawberry Wafer Roll", "Weapons > Monk", "Sweaty Tilted Forge Ratios Hardened Cultist", 100),
			...
			new ("The Sins of the Jungle", "Weapons > Monk", "Tactical Fire Forge Defends Sweaty Minion", 0),
